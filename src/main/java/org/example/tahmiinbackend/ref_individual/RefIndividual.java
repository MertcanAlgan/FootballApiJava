...
public class RefIndividual {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "refIndividual_sequence")
    @SequenceGenerator(name = "refIndividual_sequence", sequenceName = "refIndividual_sequence", allocationSize = 1)
    private Long refIndividual_id;
    private Integer id;
    ...
    private Double goals_per_match_overall;
    private Double goals_per_match_home;
    private Double goals_per_match_away;
